...
const logos = [
  {
    name: "Paypal",
    src: "assets/theme-ui/paypal.png",
  },
  {
    name: "Google",
    src: "assets/theme-ui/google.png",
  },
  {
    name: "Dropbox",
    src: "assets/theme-ui/dropbox.png",
  },
];
...
const styles = {
  section: {
    background: `transparent url(${"assets/theme-ui/banner-bg.png"}) no-repeat center top / cover`,
